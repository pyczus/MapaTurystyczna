...
if ((BlobBuilder || window.Blob) && (window.saveAs || navigator.saveBlob)) {
...
// Blobs and object URLs:
else if ((window.Blob || BlobBuilder) && URL) {
    ...
    showSave = function (data, name, mimetype) {
        ...
        if (!DownloadAttributeSupport && BrowserSupportedMimeTypes[mimetype.split(";")[0]] === true) {
